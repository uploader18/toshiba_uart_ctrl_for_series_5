...
const uint8_t  INST_ZONE1_ON[11]      = {0xF0, 0xF0, 0x0B, 0x61, 0x70, 0xE0, 0x01, 0x21, 0x03, 0xE0, 0xA0};
const uint8_t  INST_ZONE1_OFF[11]     = {0xF0, 0xF0, 0x0B, 0x61, 0x70, 0xE0, 0x01, 0x21, 0x0A, 0xE7, 0xA0}; 
const uint8_t  INST_HOTWATER_ON[11]   = {0xF0, 0xF0, 0x0B, 0x61, 0x70, 0xE0, 0x01, 0x21, 0x0C, 0xE9, 0xA0};
const uint8_t  INST_HOTWATER_OFF[11]  = {0xF0, 0xF0, 0x0B, 0x61, 0x70, 0xE0, 0x01, 0x21, 0x08, 0xE5, 0xA0}; 
const uint8_t  INST_AUTO_ON[12]       = {0xF0, 0xF0, 0x0C, 0x61, 0x70, 0xE0, 0x01, 0x24, 0x01, 0x01, 0xE3, 0xA0};
const uint8_t  INST_AUTO_OFF[12]      = {0xF0, 0xF0, 0x0C, 0x61, 0x70, 0xE0, 0x01, 0x24, 0x01, 0x00, 0xE2, 0xA0};
...
class ToshibaUART : public uart::UARTDevice, public PollingComponent {
  public:
    ...
    uint8_t  INST_SET_ZONE1_TEMP[15]    = {0xF0, 0xF0, 0x0F, 0x61, 0x70, 0xE0, 0x01, 0x23, 0x02, 0x6E, 0x66, 0xA2, 0x6E, 0xC9, 0xA0};
    uint8_t  INST_SET_HOTWATER_TEMP[15] = {0xF0, 0xF0, 0x0F, 0x61, 0x70, 0xE0, 0x01, 0x23, 0x08, 0x00, 0x00, 0xA0, 0x00, 0x8B, 0xA0};
    uint8_t  INST_REQUEST_DATA[12]       = {0xF0, 0xF0, 0x0C, 0x61, 0x70, 0xE0, 0x41, 0x5C, 0x70, 0x00, 0x8B, 0xA0};
};
